    ...
    return Card(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            _buildText(Text(job.title ?? "-", style: context.textTheme.subtitle1?.copyWith(fontWeight: AppFontUtils.medium))),
            _buildText(
              Text(
            ...
            _buildText(
              Text(
                ...
                style: context.textTheme.bodyText1?.copyWith(color: AppColors.secondary),
              ),
            ),
