...
class JobsView extends StatelessWidget {
  ...
  const JobsView({Key? key, this.isAccepted: false, this.jobs: const []}) : super(key: key);
                  ...
                  children: [
                    for (int index = 0; index < jobs.length; index++)
                      JobWidget(
                        ...
                        primaryAction: () => vm.changeTypeOfJob(index, JobType.Accepted),
                        secondaryAction: () => vm.changeTypeOfJob(index, JobType.Rejected),
                      )
                  ],
                ),
              ),
